...
/*	@Bean
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.csrf().disable().authorizeRequests()
				...
				.hasAnyRole("IFG_OWNER", "SALE_REP", "SALE_MANAGER", "DATA_ENTRY","WAREHOUSE_MANAGER")
				
				.and().authorizeRequests().antMatchers("/orderlist**")
				.hasAnyRole("IFG_OWNER", "SALE_MANAGER", "WAREHOUSE_MANAGER")

				.and().authorizeRequests().antMatchers("/ordercreation**","/saveOrder")
				.hasAnyRole("IFG_OWNER", "SALE_MANAGER","SALE_REP")
				
				.and().authorizeRequests().antMatchers("/history**")
				.hasAnyRole("IFG_OWNER", "SALE_MANAGER", "WAREHOUSE_MANAGER","SALE_REP")	
